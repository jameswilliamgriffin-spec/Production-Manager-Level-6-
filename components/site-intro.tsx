...
// Full-screen opening sequence, adapted from the Creative Alliance VFX L4 sister
// site: a drafting grid settles, a scan line passes, and "PRODUCTION MANAGER"
...
const FINAL = 'PRODUCTION MANAGER';
const RUN_MS = 2350;
const EXIT_MS = 640;
  ...
  return (
    ...
    >
      ...
      <div className="site-intro-interface">
        <div className="si-coordinates">CREATIVE ALLIANCE / BUILD 01</div>
        <div className="si-lockup">
          <div className="si-status">SCHEDULING / RESOURCING / DELIVERING</div>
          <div className="si-scramble">{display}</div>
          <div className="si-sub">LEVEL 6 &middot; PRODUCTION MANAGER APPRENTICESHIP</div>
